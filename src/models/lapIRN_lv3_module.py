...
class LapIRN_Lv3_Module(BaseModule_Registration):
    def __init__(
        self,
        netR_3: torch.nn.Module, # TODO: Miccai2020_LDR_laplacian_unit_disp_add_lvl1(2, 3, start_channel=start_channel, is_train=True, imgshape=imgshape_4,range_flow=range_flow)
        optimizer,
        params,
        # scheduler,
        *args,
    ...
    def model_step(self, batch: Any, is_3d=False, is_train=False):
        ...
        if is_3d:
            ...
            deform_field, warped_img, down_fixed_img, _, _, _, _ = self.netR_3(moving_img, fixed_img) #  F_X_Y, X_Y, Y_4x, F_xy, _ = deform_field, warped_img, down_fixed_img, displacement field, feature map
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        with optimizer_R_A.toggle_model():
            loss = self.backward_R_lv3(deform_field, warped_img, down_fixed_img)
    ...
    def configure_optimizers(self):
        ...
        optimizer_R_A = self.hparams.optimizer(params=self.netR_3.parameters())
