# ref: https://github.com/lucidrains/performer-pytorch?tab=readme-ov-file
...
from src.models.components.local_attention import LocalAttention
# from axial_positional_embedding import AxialPositionalEmbedding # For PerformerLM
...
class FastAttention(nn.Module):
    def __init__(self, dim_heads, nb_features = None, ortho_scaling = 0, causal = False, generalized_attention = False, kernel_fn = nn.ReLU(), no_projection = False):
        ...
        # print("Projection matrix shape:", self.projection_matrix.shape)
...
class Attention(nn.Module):
    def __init__(
        ...
        generalized_attention = False, # False 원래코드
        kernel_fn = nn.ReLU(),
        dropout = 0.,
        no_projection = False,
        qkv_bias = False,
...
class Performer(nn.Module):
    def __init__(
        ...
        reversible = False,
        ff_chunks = 1,
        generalized_attention = False, # False 원래 이거
        kernel_fn = nn.ReLU(),
        use_scalenorm = False,
        use_rezero = False,
        ff_glu = False,
