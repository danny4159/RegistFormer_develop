...
class DAModule(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.conv0 = ModulatedStyleConv(self.input_nc, self.feat_ch, self.feat_ch, kernel_size=3,
                                            activate=True, demodulate=self.demodulate)
        self.conv11 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=True, activate=True, demodulate=self.demodulate)
        self.conv12 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=False, activate=True, demodulate=self.demodulate)
        self.conv21 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=True, activate=True, demodulate=self.demodulate)
        self.conv22 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=False, activate=True, demodulate=self.demodulate)
        self.conv31 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=False, activate=True, demodulate=self.demodulate)
        self.conv32 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                downsample=False, activate=True, demodulate=self.demodulate)
        self.conv41 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                upsample=True, activate=True, demodulate=self.demodulate)
        self.conv42 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                upsample=False, activate=True, demodulate=self.demodulate)
        self.conv51 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                upsample=True, activate=True, demodulate=self.demodulate)
        self.conv52 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.feat_ch, kernel_size=3,
                                upsample=False, activate=True, demodulate=self.demodulate)
        self.conv6 = ModulatedStyleConv(self.feat_ch, self.feat_ch, self.output_nc, kernel_size=3,
