...
class TransMorph(nn.Module):
    def __init__(self, **kwargs):
        try:
            if_convskip = kwargs['if_convskip']
            if_transskip = kwargs['if_transskip']
            ...
            pat_merg_rf = kwargs['pat_merg_rf'] 
            reg_head_chan = kwargs['reg_head_chan'] 
        ...
        self.transformer = SwinTransformer(patch_size=patch_size,
                                           in_chans=in_chans,
                                           embed_dim=embed_dim,
                                           depths=depths,
                                           num_heads=num_heads,
        ...
        self.up4 = DecoderBlock(embed_dim//2, reg_head_chan, skip_channels=reg_head_chan if if_convskip else 0, use_batchnorm=False)  # 384, 160, 160, 256
