    ...
    def __init__(
        ...
        **kwargs,
        ...
        if cross_attn_windows is None:
            cross_attn_windows = [cross_attn_window] * 3
        if len(cross_attn_windows) != 3:
            raise ValueError(f"cross_attn_windows must have 3 values for attn3/4/5, got {cross_attn_windows}")
        ...
        if self.use_transformer_attn:
            ...
            self.trans3 = make_trans(self.cross_attn_windows[0])
            self.trans4 = make_trans(self.cross_attn_windows[1])
            self.trans5 = make_trans(self.cross_attn_windows[2])
            ...
            self.attn3 = make_attn(self.cross_attn_windows[0])
            self.attn4 = make_attn(self.cross_attn_windows[1])
            self.attn5 = make_attn(self.cross_attn_windows[2])
