...
class BaseModule_AtoB(LightningModule):  # single direction
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        if self.params.eval_on_align:
            ...
            self.val_lpips_B.update(gray2rgb(real_B.clamp(-1, 1)), gray2rgb(fake_B.clamp(-1, 1)))
            ...
            if self.has_multiple_outputs:
                ...
                self.val_lpips_C.update(gray2rgb(real_C.clamp(-1, 1)), gray2rgb(fake_C.clamp(-1, 1)))
                ...
                if fake_D is not None:
                    ...
                    self.val_lpips_D.update(gray2rgb(real_D.clamp(-1, 1)), gray2rgb(fake_D.clamp(-1, 1)))
    ...
    def test_step(self, batch: Any, batch_idx: int):
        ...
        if self.params.eval_on_align:
            ...
            self.test_lpips_B.update(gray2rgb(real_B.clamp(-1, 1)), gray2rgb(fake_B.clamp(-1, 1)))
            ...
            if self.has_multiple_outputs:
                ...
                self.test_lpips_C.update(gray2rgb(real_C.clamp(-1, 1)), gray2rgb(fake_C.clamp(-1, 1)))
                ...
                if fake_D is not None:
                    ...
                    self.test_lpips_D.update(gray2rgb(real_D.clamp(-1, 1)), gray2rgb(fake_D.clamp(-1, 1)))
